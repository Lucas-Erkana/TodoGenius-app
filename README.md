...
>In this react project I created a full website for the To do app, consisting of several pages and using the components I have already created. By adding a About author page, About app page and To do list page.



</div>
 <!-- <img src="/images/Todo-app.gif" alt="Todo Demo" width="650"  height="450" /> -->
<div>
...
- [React]((https://ibaslogic.com/react-tutorial-for-beginners/))
...
- **Add tasks**
- **Delete tasks**
- **Check and strike through a completed task**
- **Edit a task**
...
```sh
  git clone https://github.com/Lucash2022/react-todo-app.git
  cd react-todo-app
```
...
Feel free to check the [issues page](https://github.com/Lucash2022/react-todo-app/issues).
